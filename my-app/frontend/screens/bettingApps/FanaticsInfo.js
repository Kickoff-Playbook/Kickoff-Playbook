...
export default function FanaticsInfo({ navigation }) {
  const sports = [
  ...
  const handleSportPress = (sport) => {
    console.log(`Selected ${sport.name} for Fanatics`);
  };
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.appInfo}>
            <Text style={styles.appName}>Fanatics</Text>
            <Text style={styles.appTagline}>Fanatics Sportsbook</Text>
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.detailCard}>
          ...
          <Text style={styles.bonusText}>Bet $5, Get $150 in Bonus Bets</Text>
        </View>

        <View style={styles.detailCard}>
          <Text style={styles.cardTitle}>⭐ Key Features</Text>
          <View style={styles.featuresList}>
            <Text style={styles.featureItem}>• FanCash Rewards</Text>
            <Text style={styles.featureItem}>• Live Betting</Text>
            <Text style={styles.featureItem}>• Exclusive Gear</Text>
      ...
      <View style={styles.footerInfo}>
        <Text style={styles.footerText}>
          🏪 Fanatics combines sports betting with exclusive merchandise
          rewards. Perfect for beginners who love sports gear!
        </Text>
      </View>
    </ScrollView>
  );
