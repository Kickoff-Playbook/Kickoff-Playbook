...
export default function CaesarsInfo({ navigation }) {
  const sports = [
  ...
  const handleSportPress = (sport) => {
    console.log(`Selected ${sport.name} for Caesars`);
  };
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.appInfo}>
            <Text style={styles.appName}>Caesars</Text>
            <Text style={styles.appTagline}>Caesars Sportsbook & Casino</Text>
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.detailCard}>
          ...
          <Text style={styles.bonusText}>First Bet on Caesars up to $1250</Text>
        </View>

        <View style={styles.detailCard}>
          <Text style={styles.cardTitle}>⭐ Key Features</Text>
          <View style={styles.featuresList}>
            <Text style={styles.featureItem}>• Caesars Rewards</Text>
            <Text style={styles.featureItem}>• Odds Boost</Text>
            <Text style={styles.featureItem}>• Live Betting</Text>
            <Text style={styles.featureItem}>• Complex Markets</Text>
          </View>
        </View>

        <View style={styles.warningCard}>
          <Text style={styles.warningTitle}>⚠️ Advanced Platform</Text>
          <Text style={styles.warningText}>
            Caesars offers extensive betting markets and casino integration.
            Best suited for experienced bettors familiar with complex wagering
            options.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.footerInfo}>
        <Text style={styles.footerText}>
          🏛️ Caesars combines sportsbook with full casino experience and rewards
          program. Recommended for experienced bettors seeking comprehensive
          gaming options!
        </Text>
      </View>
    </ScrollView>
