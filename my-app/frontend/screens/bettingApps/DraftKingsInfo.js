...
export default function DraftKingsInfo({ navigation }) {
  const sports = [
  ...
  const handleSportPress = (sport) => {
    console.log(`Selected ${sport.name} for DraftKings`);
  };
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.appInfo}>
            <Text style={styles.appName}>DraftKings</Text>
            <Text style={styles.appTagline}>
              Daily Fantasy Sports & Sportsbook
            </Text>
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.detailCard}>
          ...
          <Text style={styles.bonusText}>Bet $5, Get $200</Text>
        </View>
        ...
        <View style={styles.detailCard}>
          ...
          <View style={styles.featuresList}>
            ...
            <Text style={styles.featureItem}>• Same Game Parlays</Text>
            <Text style={styles.featureItem}>• Early Cash Out</Text>
            <Text style={styles.featureItem}>• DFS Integration</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.footerInfo}>
        <Text style={styles.footerText}>
          📊 DraftKings offers advanced features like same-game parlays and live
          betting. Great for users with some betting experience!
        </Text>
      </View>
    </ScrollView>
  );
