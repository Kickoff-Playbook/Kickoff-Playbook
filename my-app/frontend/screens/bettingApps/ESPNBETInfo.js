...
export default function ESPNBETInfo({ navigation }) {
  const sports = [
  ...
  const handleSportPress = (sport) => {
    console.log(`Selected ${sport.name} for ESPN BET`);
  };
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.appInfo}>
            <Text style={styles.appName}>ESPN BET</Text>
            <Text style={styles.appTagline}>ESPN's Official Sportsbook</Text>
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.detailCard}>
          ...
          <Text style={styles.bonusText}>First Bet Reset up to $1000</Text>
        </View>

        <View style={styles.detailCard}>
          <Text style={styles.cardTitle}>⭐ Key Features</Text>
          <View style={styles.featuresList}>
            <Text style={styles.featureItem}>• ESPN Integration</Text>
            <Text style={styles.featureItem}>• Live Betting</Text>
            <Text style={styles.featureItem}>• Sports News</Text>
            <Text style={styles.featureItem}>• Expert Analysis</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.footerInfo}>
        <Text style={styles.footerText}>
          📺 ESPN BET combines the trusted ESPN brand with comprehensive sports
          betting. Great for sports fans who want integrated news and analysis!
        </Text>
      </View>
    </ScrollView>
  );
