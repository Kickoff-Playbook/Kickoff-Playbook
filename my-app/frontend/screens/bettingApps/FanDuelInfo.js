...
export default function FanDuelInfo({ navigation }) {
  const sports = [
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.appInfo}>
            <Text style={styles.appName}>FanDuel</Text>
            <Text style={styles.appTagline}>America's #1 Sportsbook</Text>
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.detailCard}>
          ...
          <Text style={styles.bonusText}>Bet $5, Get $150</Text>
        </View>
        ...
        <View style={styles.detailCard}>
          ...
          <View style={styles.featuresList}>
            ...
            <Text style={styles.featureItem}>• Parlay Boosts</Text>
      ...
      <View style={styles.footerInfo}>
        <Text style={styles.footerText}>
          🏆 FanDuel is America's #1 Sportsbook with great parlay boosts and
          live streaming. Perfect balance of features for intermediate users!
        </Text>
      </View>
    </ScrollView>
  );
